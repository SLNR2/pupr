...
Make sure to add throws SQLNonTransientConnectionException, IOException, SQLException when appropriate for each method
...
//Do these methods need to pass a userId to return the correct user?
   ...
   public String getUsername() throws SQLNonTransientConnectionException, IOException, SQLException  {return this.username;
